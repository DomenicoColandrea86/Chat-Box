...
var appServices = appServices || angular.module('appServices', []);

appServices.constant('useragentmsgs', {
  'errors.useragent.notFound':'unknown',
});
appServices.constant('geolocation_msgs', {
...
appServices.factory('useragent', ['$q', '$rootScope', '$window', 'useragentmsgs', function ($q,$rootScope,$window,useragentmsgs) {
  return {
...
appServices.factory('geolocation', ['$q','$rootScope','$window', '$http', 'geolocation_msgs',function ($q, $rootScope, $window, $http, geolocation_msgs) {
  return {
